...
public class SettingsActivity extends AppCompatActivity {
    ...
    /*
     * true  = opened from drawer as a dialog-only option
     * false = opened as complete Settings screen
     */
    ...
    private static final String PROFILE_IMAGE_URI =
            "profile_image_uri";

    private static final String APP_LOCK_ENABLED =
            "app_lock_enabled";

    private static final String APP_PIN =
            "app_pin";

    private static final String AUTO_LOCK_ENABLED =
            "auto_lock_enabled";

    private static final String AUTO_LOCK_TIME =
            "auto_lock_time";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // =====================================================
        // DIALOG-ONLY SETTINGS OPTIONS
        // =====================================================

        if (requestedSection != null &&
                !requestedSection.trim().isEmpty()) {
    ...
    private void initializeViews() {
        ...
        changeProfileText =
                findViewById(R.id.changeProfileText);

        profileInfoName =
                findViewById(R.id.profileInfoName);

        profileInfoEmail =
                findViewById(R.id.profileInfoEmail);
    }
     ...
     *
     * Dialog-only SettingsActivity has a transparent window.
     * Simply calling finish() can leave the user seeing
     * a black/transparent screen depending on the activity stack.
     *
     * This method explicitly returns to HomeActivity.
     */
    ...
    private void loadUserProfile() {
        ...
        if (user == null) {
            ...
            if (profileInfoName != null) {

                profileInfoName.setText("User");
            }

            if (profileInfoEmail != null) {

                profileInfoEmail.setText(
                        "No email available"
                );
            }
        ...
        if (enabled &&
            ...
            dialog =
                    new AlertDialog.Builder(this)
                            .setTitle("App Lock")
                            .setMessage(
                                    "Protect Wault.io with a 4-digit PIN."
                            )
                            .setNegativeButton(
                                    "Cancel",
                                    (d, which) ->
    ...
    private void enableAppLock() {
        ...
        /*
         * Do NOT call exitDialogMode() here.
         *
         * PinSetupActivity must remain visible.
         */
        if (dialogOnlyMode) {
        ...
        if (enabled) {
            ...
            dialog =
                    new AlertDialog.Builder(this)
                            .setTitle("Auto Lock")
                            .setMessage(
                                    "Auto Lock is currently enabled.\n\n" +
                                            "Wault.io will lock after " +
                    ...
                    d -> {
                        ...
                        dialog.getButton(
                                ...
                                v -> {
                                    ...
                                    showToast(
                                            "Auto Lock enabled for 30 seconds"
                                    );
    ...
    private void createBackup(
        ...
        DatabaseReference passwordsRef =
                FirebaseDatabase
                        .getInstance()
                        .getReference("users")
                        .child(user.getUid())
                ...
                .addOnCompleteListener(
                        deleteTask -> {
                            ...
                            if (!deleteTask.isSuccessful()) {
                                ...
                                showToastLong(
                                        "Failed to clear existing passwords"
                                );
                            ...
                            Map<String, Object> restoredData =
                                    new HashMap<>();
    ...
    protected void onResume() {
        ...
        /*
         * Dialog-only mode should never load
